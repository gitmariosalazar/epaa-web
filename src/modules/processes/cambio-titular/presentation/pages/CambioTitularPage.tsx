/**
 * CambioTitularPage — Módulo: cambio-titular
...
import { GetCambioTitularRequisitosUseCase } from '../../application/usecases/GetCambioTitularRequisitosUseCase';
import { CambioTitularRepositoryImpl } from '../../infrastructure/repositories/CambioTitularRepositoryImpl';
import type { CambioTitular } from '../../domain/models/CambioTitular';
import { Users, Clock, DollarSign, FileText, AlertCircle } from 'lucide-react';
        ...
        <div className="tp-scroll-layout">
          ...
          <div className="tp-scroll-layout__left">
            <div className="tp-scroll-layout__sticky">
              <div>
                <h1 style={{ margin: 0, fontSize: '1.1rem', fontWeight: 800, color: 'var(--text-main)', lineHeight: 1.25 }}>Cambio de Titular</h1>
                <span style={{ color: 'var(--text-secondary)', fontSize: '0.78rem' }}>Actualizar el titular de la cuenta de agua</span>
              </div>
              <div className="tp-hero" style={{ borderColor: `${COLOR}30`, padding: '0.875rem 1.1rem' }}>
                <div className="tp-hero__icon" style={{ background: `${COLOR}20`, color: COLOR, width: 40, height: 40 }}><Users size={19} /></div>
              ...
              <div className="tp-card__body" style={{ padding: '0.875rem 1rem' }}>
                <div className="tp-info-list">
                  {[
                    ...
                    { icon: <DollarSign size={13} />, label: 'Costo estimado', value: `$${data.costoTotal} USD`, colored: true },

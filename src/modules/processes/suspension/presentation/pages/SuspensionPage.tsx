/**
 * SuspensionPage — Módulo: suspension
...
import { GetSuspensionRequisitosUseCase } from '../../application/usecases/GetSuspensionRequisitosUseCase';
import { SuspensionRepositoryImpl } from '../../infrastructure/repositories/SuspensionRepositoryImpl';
import type { Suspension } from '../../domain/models/Suspension';
import { XCircle, Clock, DollarSign, FileText, AlertCircle } from 'lucide-react';
        ...
        <div className="tp-scroll-layout">
          ...
          <div className="tp-scroll-layout__left">
            <div className="tp-scroll-layout__sticky">
              <div>
                <h1 style={{ margin: 0, fontSize: '1.1rem', fontWeight: 800, color: 'var(--text-main)', lineHeight: 1.25 }}>Suspensión del Servicio</h1>
                <span style={{ color: 'var(--text-secondary)', fontSize: '0.78rem' }}>Suspensión temporal o definitiva del suministro</span>
              </div>
              <div className="tp-hero" style={{ borderColor: `${COLOR}30`, padding: '0.875rem 1.1rem' }}>
                <div className="tp-hero__icon" style={{ background: `${COLOR}20`, color: COLOR, width: 40, height: 40 }}><XCircle size={19} /></div>
              ...
              <div className="tp-card__body" style={{ padding: '0.875rem 1rem' }}>
                <div className="tp-info-list">
                  {[
                    ...
                    { icon: <DollarSign size={13} />, label: 'Costo total', value: `$${data.costoTotal} USD`, colored: true },

/**
 * BeneficioTerceraEdadPage — Módulo: beneficio-tercera-edad
...
import { GetBeneficioTerceraEdadRequisitosUseCase } from '../../application/usecases/GetBeneficioTerceraEdadRequisitosUseCase';
import { BeneficioTerceraEdadRepositoryImpl } from '../../infrastructure/repositories/BeneficioTerceraEdadRepositoryImpl';
import type { BeneficioTerceraEdad } from '../../domain/models/BeneficioTerceraEdad';
import { Heart, Clock, DollarSign, FileText, AlertCircle } from 'lucide-react';
        ...
        <div className="tp-scroll-layout">
          ...
          <div className="tp-scroll-layout__left">
            <div className="tp-scroll-layout__sticky">
              <div>
                <h1 style={{ margin: 0, fontSize: '1.1rem', fontWeight: 800, color: 'var(--text-main)', lineHeight: 1.25 }}>Descuento Tercera Edad</h1>
                <span style={{ color: 'var(--text-secondary)', fontSize: '0.78rem' }}>Beneficio para adultos mayores (65+ años)</span>
              </div>
              <div className="tp-hero" style={{ borderColor: `${COLOR}30`, padding: '0.875rem 1.1rem' }}>
                <div className="tp-hero__icon" style={{ background: `${COLOR}20`, color: COLOR, width: 40, height: 40 }}><Heart size={19} /></div>

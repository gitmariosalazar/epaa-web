...
import { CheckCircle, Calculator, List } from 'lucide-react';
...
export const ReadingsWithErrors: React.FC = () => {
  ...
  const [activeTab, setActiveTab] = useState<ReadingDataTab>('completed');

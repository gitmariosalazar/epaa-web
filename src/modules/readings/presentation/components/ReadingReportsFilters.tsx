...
import '../../../incidents/presentation/styles/IncidentFilters.css';
import { Divider } from '@/shared/presentation/components/divider/Divider';
import { FaFilter } from 'react-icons/fa';
import { DatePicker } from '@/shared/presentation/components/DatePicker/DatePicker';

interface ReadingReportsFiltersProps {
  searchQuery: string;
...
export const ReadingReportsFilters: React.FC<ReadingReportsFiltersProps> = ({
  searchQuery,
  onSearchQueryChange,
  searchField,
  onSearchFieldChange,

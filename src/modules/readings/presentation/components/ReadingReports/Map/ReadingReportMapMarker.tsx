...
import {
  ReadingReportMapInstantTooltip,
  PRIORITY_CONFIG,
  DEFAULT_CONFIG
} from './ReadingReportMapInstantTooltip';

interface ReadingReportMapMarkerProps {
...
/**
 * ReadingReportMapMarker — SRP: solo renderiza el marcador pulsante en el mapa.
 ...
 *  - BAJA    → verde
 */
export const ReadingReportMapMarker: React.FC<ReadingReportMapMarkerProps> = ({
  incident,
  isHovered,
  isSelected,
  onClick
  ...
  return (
    ...
    >
      {isHovered && <ReadingReportMapInstantTooltip incident={incident} />}

...
// Styles
import './ReadingReportMapInfoWindow.css';
...
interface ReadingReportMapInfoWindowProps {
...
/**
 * ReadingReportMapInfoWindow — SRP: solo renderiza el popup de info del incidente.
 * Se muestra al hacer click en un marcador.
 * ISP: recibe solo los datos que necesita, sin el contexto entero.
 */
export const ReadingReportMapInfoWindow: React.FC<ReadingReportMapInfoWindowProps> = memo(
  ({
    incident,
    theme,
    onClose,

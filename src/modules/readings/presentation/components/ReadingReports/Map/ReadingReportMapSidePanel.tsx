...
import './ReadingReportMapSidePanel.css';
...
interface ReadingReportMapSidePanelProps {
...
/**
 * ReadingReportMapSidePanel — SRP: lista lateral de incidentes en la vista mapa.
 * Permite seleccionar un incidente para centrarlo en el mapa.
 * OCP: extensible sin modificar (solo agregar props).
 */
export const ReadingReportMapSidePanel: React.FC<ReadingReportMapSidePanelProps> = ({
  incidents,
  selectedIncident,
  onSelect,
  onViewDetail,

...
import { ReadingReportMapMarker } from './ReadingReportMapMarker';
import { ReadingReportMapInfoWindow } from './ReadingReportMapInfoWindow';
import { FALLBACK_CENTER_ANTONIO_ANTE } from '@/shared/utils/types/IGeolocationData';
import { useNavigate } from 'react-router-dom';

// ── Props ────────────────────────────────────────────────────────────────────
export interface ReadingReportMapProps {
...
// ─────────────────────────────────────────────────────────────────────────────
// ReadingReportMap — componente principal
...
// ─────────────────────────────────────────────────────────────────────────────
export const ReadingReportMap: React.FC<ReadingReportMapProps> = ({
  incidents,
  selectedIncident,
  onSelect,
  center,

...
interface ReadingReportMapInstantTooltipProps {
  incident: IncidentDetailRowResponse;
}

/**
 * ReadingReportMapInstantTooltip — SRP: solo renderiza el tooltip flotante del marcador.
 * Se muestra al hacer hover sobre el marcador (sin latencia).
 */
export const ReadingReportMapInstantTooltip: React.FC<ReadingReportMapInstantTooltipProps> = ({
  incident,
}) => {

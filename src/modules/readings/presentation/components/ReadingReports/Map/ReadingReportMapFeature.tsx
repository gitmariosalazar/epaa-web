...
import { ReadingReportMap } from './ReadingReportMap';
import { ReadingReportMapSidePanel } from './ReadingReportMapSidePanel';
import type { IncidentDetailRowResponse } from '../../../../../incidents/domain/schemas/dtos/response/view_incident.response';
import './ReadingReportMap.css';
...
export interface ReadingReportMapFeatureProps {
...
/**
 * ReadingReportMapFeature — Composition root for the incident map view.
 *
...
/** 
 * Map Feature for Reading Reports (forces TS Server refresh)
 */
export const ReadingReportMapFeature: React.FC<ReadingReportMapFeatureProps> = ({
  incidents,
  selectedIncident,
  onSelect,
  onViewDetail,

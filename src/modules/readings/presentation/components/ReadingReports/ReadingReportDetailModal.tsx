...
import { PhotoLightbox } from '../../../../incidents/presentation/components/PhotoLightbox';
...
import '../../../../incidents/presentation/styles/IncidentDetailModal.css';
import { GiPhone } from "react-icons/gi";

// ─── Types ─────────────────────────────────────────────────────────────────────

interface ReadingReportDetailModalProps {
  isOpen: boolean;
  onClose: () => void;
 ...
 */
export const ReadingReportDetailModal: React.FC<ReadingReportDetailModalProps> = ({
  isOpen,
  onClose,
  incident
}) => {

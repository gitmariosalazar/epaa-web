...
import '../../../../incidents/presentation/styles/ResolveIncidentModal.css';
import { IncidentWorkorderDetail } from '../../../../incidents/presentation/components/IncidentWorkorderDetail';
...
interface ResolveReadingReportModalProps {
  isOpen: boolean;
  onClose: () => void;
  incidentId: string;
}
...
export const ResolveReadingReportModal: React.FC<ResolveReadingReportModalProps> = ({
  isOpen,
  onClose,
  incidentId
}) => {

  ...
  "translation": {
    ...
    "connections": {
      ...
      "table": {
        ...
        "noDataDescription": "No se encontraron conexiones con los filtros actuales.",
        "sector": "Sector",
        "client": "Cliente",
      ...
      "deleteConfirm": "¿Está seguro que desea eliminar esta conexión? Esta acción no se puede deshacer.",
      "noDataDescription": "No se encontraron conexiones con los filtros actuales. Usa Consultar para cargar datos.",
      "tabs": {
      ...
      "wizard": {
        ...
        "clientSelection": {
          ...
          "description": "Ingrese la identificación del cliente para encontrar registros automáticamente o registrar uno nuevo.",
          "person": "Persona",
          "company": "Empresa",
        ...
        "propertySelectionDesc": "Selecciona una propiedad existente o continúa sin asignar una.",
        "noProperties": "El cliente seleccionado no tiene propiedades registradas.",

  ...
  items: [
    {
      ...
      subItems: [
        ...
        generateTramiteMenu(
          ...
          'Cambio de Titular',
          'cambio_titular',
          { general: '/procedures/cambio-titular' },
          true
        ),
        generateTramiteMenu(
          <XCircle size={18} />,
        ...
        generateTramiteMenu(
          <Heart size={18} />,
          'Tercera Edad',
          'beneficio_tercera_edad',
          { general: '/procedures/tercera-edad' },
          true
        ),
        generateTramiteMenu(
          <FaWheelchair size={16} />,
          'Discapacidad',
          'beneficio_discapacidad',
          { general: '/procedures/discapacidad' },
          true
        ),
        {
          icon: <Wrench size={18} />,
